...
public class ProductoController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductoModel> updateProducto(@PathVariable Long id, @RequestBody ProductoModel producto) {
        Optional<ProductoModel> existingProduct = productoService.getProducto(id);

        if (existingProduct.isPresent()) {
            ProductoModel updatedProduct = productoService.updateProducto(id, producto);
